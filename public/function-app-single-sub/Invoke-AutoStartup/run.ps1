...
.DESCRIPTION
    Single-subscription variant. Intended for use when the Managed Identity has roles
    assigned at Management Group scope (covering all subscriptions automatically).
    The function runs in the context of the subscription it is deployed into.
    ...
    Tag format:
      ...
      startup = 06:30   →  VM is started at 06:30 local time (per TIMEZONE app setting)
